...
def compute_minima(key, chains_index, target_stream_clean=target_stream_clean, noise_std=noise_std, nsteps = 10, num_langevine_samples=50):
    ...
    def langevin_sampler(initial_params, num_samples, step_size, rng_key):
        ...
        for i in tqdm(range(num_samples)):
            grads = jax.grad(time_integration_for_langevin)(params, rng_key)
