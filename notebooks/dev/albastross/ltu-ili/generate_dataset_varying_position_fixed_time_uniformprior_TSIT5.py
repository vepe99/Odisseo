...
for i in tqdm(range(name_str, num_chunks, batch_size)):
    ...
    parameter_value = jax.random.uniform(rng_key, 
                                         ...
                                         minval=jnp.array([params_true.NFW_params.Mvir * code_units.code_mass.to(u.Msun) * 0.5,  
                                                           ...
                                                           params_true.PSP_params.r_c * code_units.code_length.to(u.kpc) * 0.5,
                                                           10.0, #x
                                                           0.1, #y
                                                           6.0, #z
                                                           90.0, #vx
    ...
    for j in range(batch_size):
        np.savez_compressed(f"/export/data/vgiusepp/odisseo_data/data_varying_position_fixed_time_uniform_prior_TSTIT5/file_{name_str:06d}.npz",
                            x = stream_samples[j],
